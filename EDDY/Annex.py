...
class TextSpeech:
    ...
    def opentxt(self):
        ...
        try:
            file_path=filedialog.askopenfilename(initialdir =r"C:\Users\Md NAYAB ANSARI\OneDrive\Desktop\Desktop Assistant\Notes",title="Select file",filetypes=(('text file',"*.txt"),("All files", "*.*")))
    ...
    def __init__(self):
        ...
        #root widget
        self.text=scrolledtext.ScrolledText(self.root,width=50,height=15,wrap=tk.WORD,padx=20,pady=10,borderwidth=8,relief=tk.RIDGE)
...
class SettingWindow:
    ...
    def settingWindow(self,root):
        ...
        self.volume=ttk.Label(self.setting,text="EDDY's Volume: ",borderwidth=0,font=('"Times New Roman"')).place(x=3,y=17)
...
class News:
    ...
    def show(self):
        ...
        r=requests.get('https://newsapi.org/v2/top-headlines?country=in&apiKey=255b9b624edd43aa847bdc63095d4892')
